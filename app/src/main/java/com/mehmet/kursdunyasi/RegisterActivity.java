...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private  EditText registerUserNameEdittext,registerNameEdittext,registerSurNameEdittext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.registerMailEdittext);

        mPasswordView = (EditText) findViewById(R.id.registerPasswordEdittext);
        ...
        mProgressView = findViewById(R.id.regsiter_progress);
    ...
    public void register(String email,String userName,String name,String surName,String password){

        Call<RegisterPojo> request= ManagerAll.getOurInstance().register(email, userName, name, surName, password);
        request.enqueue(new Callback<RegisterPojo>() {
            ...
            public void onResponse(Call<RegisterPojo> call, Response<RegisterPojo> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    Log.i("istekmi",response.body().getMessage()+" "+response.code());

                    String mail=mEmailView.getText().toString();
                    String password=mPasswordView.getText().toString();

                    SharedPreferences sharedPreferences=getApplicationContext().getSharedPreferences("kayit",0);
                    SharedPreferences.Editor editor=sharedPreferences.edit();
                    editor.putString("mail",mail);
                    editor.putString("password",password);
                    editor.commit();

                    LoginActivity.state=false;
