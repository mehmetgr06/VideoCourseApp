...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPreferences.getString("token",null)!=null){
            ...
            Intent intent=new Intent(LoginActivity.this,NavigationBottomActivity.class);
        ...
        sharedPreferences2=getApplicationContext().getSharedPreferences("kayit",0); //Kayıttan Gelen değerleri otomatik doldurur
        mEmailView.setText(sharedPreferences2.getString("mail",null));
        mPasswordView.setText(sharedPreferences2.getString("password",null));
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
           ...
           // showProgress(true); //PROGRES DIALOG İPTAL EDİLDİ
    ...
    public void login(String mail,String password){
        ...
        Call<LoginPojo> request= ManagerAll.getOurInstance().login(mail, password);
            ...
            public void onResponse(Call<LoginPojo> call, Response<LoginPojo> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    if(response.body()!=null){
                        ...
                        String surName=response.body().getSurname();
                        ...
                        Intent intent=new Intent(LoginActivity.this,NavigationBottomActivity.class);
                        startActivity(intent);
                        Log.i("veriler",response.body().toString());
                    ...
                    Toast.makeText(LoginActivity.this, "Hatalı Bilgi Girdiniz", Toast.LENGTH_SHORT).show();
                }
    ...
    public void getProfilePhoto(){
        ...
        call.enqueue(new Callback<UploadImagePojo>() {
            ...
            public void onResponse(Call<UploadImagePojo> call, Response<UploadImagePojo> response) {
                ...
                if(response.isSuccessful()) {
                   /* String link=response.body().getPicture();
                    sharedPreferences3=getApplicationContext().getSharedPreferences("link",0);
                    SharedPreferences.Editor editor=sharedPreferences3.edit();
                    editor.putString("linko",link);
                    editor.commit();*/

                   link=response.body().getPicture();
                }
